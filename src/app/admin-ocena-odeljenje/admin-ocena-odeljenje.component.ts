...
@Component({
  selector: 'app-admin-ocena-odeljenje',
  templateUrl: './admin-ocena-odeljenje.component.html',
  styleUrls: ['./admin-ocena-odeljenje.component.css']
})
export class AdminOcenaOdeljenjeComponent implements OnInit {
  odeljenja: Odeljenje[];
